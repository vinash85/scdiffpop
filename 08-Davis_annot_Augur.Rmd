...
```{r}
load("/Users/phillipnicol/Desktop/local_files/data/scDiffPopDATA/Augur/augur_BLOOD_V_TUMOR.RData")
augur$AUC
```
...
```{r}
load("/Users/phillipnicol/Desktop/local_files/data/scDiffPopDATA/Augur/augur_BLOOD_V_TUMOR_RANDOMIZED.RData")
